...
let { nestedName:muppetName, nestedColor:color,album:song, nestedJob:job, nestedPartner:partner } = nestedMuppet;

// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partner
const { 
  nestedName,nestedColor,nestedJob, nestedPartner,album: {  theMuppetMovie: {  song1,song2,song3,song4}}} = nestedMuppet;